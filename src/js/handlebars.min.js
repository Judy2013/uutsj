...
var r=i(t[s],this);"undefined"!==r&&e.push([this.quotedString(s),":",r])}var n=this.generateList(e);return n.prepend("{"),n.add("}"),n},generateList:function(t,e){for(var s=this.empty(e),r=0,n=t.length;n>r;r++)r&&s.add(","),s.add(i(t[r],this,e));return s},generateArray:function(t,e){var s=this.generateList(t,e);return s.prepend("["),s.add("]"),s}},e["default"]=r,t.exports=e["default"]}])}),function(t){var e=function(t){t.registerHelper("ifCond",function(t,e,s,i){switch(e){case"==":return t==s?i.fn(this):i.inverse(this);case"===":return t===s?i.fn(this):i.inverse(this);case"<":return s>t?i.fn(this):i.inverse(this);case"<=":return s>=t?i.fn(this):i.inverse(this);case">":return t>s?i.fn(this):i.inverse(this);case">=":return t>=s?i.fn(this):i.inverse(this);default:return i.inverse(this)}return i.inverse(this)})};"undefined"!=typeof module&&module.exports&&(module.exports=e),this.Handlebars&&e(Handlebars)}.call(this);